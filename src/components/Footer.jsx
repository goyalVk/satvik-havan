    ...
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div className="footer-col">
          <h4>Shop</h4>
          <ul>
            <li><Link href="/herbs">All Herbs</Link></li>
            <li><Link href="/herbs?cat=immunity">Immunity Herbs</Link></li>
            <li><Link href="/herbs?cat=skin">Skin & Beauty</Link></li>
            <li><Link href="/herbs?cat=hair">Hair Care</Link></li>
            <li><Link href="/herbs?cat=digestion">Digestion</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          <h4>Services</h4>
          <ul>
            <li><Link href="/booking">Book Pandit Ji</Link></li>
            <li><Link href="/booking">Online Pooja</Link></li>
            <li><Link href="/booking">Gruhapravesam Kit</Link></li>
            <li><Link href="/booking">Corporate Puja</Link></li>
            <li><Link href="/booking">Vastu Consultation</Link></li>
            <li><Link href="/blogs">Ayurveda Blog</Link></li>
          </ul>
        </div>
