  ...
  if (!blog) {
    return (
      <div style={{ textAlign: "center", padding: "80px 24px" }}>
        ...
        <Link to="/blogs" className="btn-saffron">← All Blogs</Link>
      </div>
    );
  }
    ...
    <>
      ...
      <section style={{
        ...
        <nav style={{ fontSize: 12, color: "var(--text-muted)", marginBottom: 20 }}>
          ...
          {" › "}
          <Link to="/blogs" style={{ color: "var(--saffron)" }}>Blog</Link>
          {" › "}
        ...
        <section className="section section-cream">
          <div className="container">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: 20 }}>
              {otherBlogs.map(b => (
                <Link key={b.id} to={`/blogs/${b.slug}`} style={{ textDecoration: "none" }}>
                  <div style={{
      ...
      <section className="cta-section">
        ...
        <div className="cta-btns">
          <Link to="/herbs" className="btn-gold" style={{ fontSize: 15, padding: "13px 28px" }}>
            🌿 Browse All Herbs
          </Link>
