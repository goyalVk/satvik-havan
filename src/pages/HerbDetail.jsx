  ...
  if (!product) {
    return (
      <div style={{ textAlign: "center", padding: "80px 24px" }}>
        ...
        <Link to="/herbs" className="btn-saffron">← Back to All Herbs</Link>
      </div>
    );
  }
    ...
    <>
      ...
      <section className="herb-detail-hero">
        <nav style={{ fontSize: 12, color: "var(--text-muted)", maxWidth: 1000, margin: "0 auto 20px" }}>
          <Link to="/" style={{ color: "var(--saffron)" }}>Home</Link>
          {" › "}
          <Link to="/herbs" style={{ color: "var(--saffron)" }}>Herbs</Link>
          {" › "}
        ...
        <div className="herb-detail-grid">
          ...
          <div className="herb-detail-info">
            ...
            <div className="herb-detail-actions">
              ...
              <Link to="/herbs" className="btn-outline">← All Herbs</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {similar.length > 0 && (
        <section className="similar-herbs">
          ...
          <div className="similar-grid">
            {similar.map(sp => (
              <Link key={sp.id} to={`/herbs/${sp.slug}`} style={{ textDecoration: "none" }} className="herb-card">
      ...
      <section className="cta-section">
        ...
        <div className="cta-btns">
          ...
          <Link to="/herbs" className="btn-gold" style={{ fontSize: 16, padding: "15px 32px" }}>
            Browse More Herbs
          </Link>
        </div>
      </section>
